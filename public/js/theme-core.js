...
(function () {
    ...
    var Core = {
        ...
        v_NavMenu: function () {
            ...
            $("#mainMenu li.dropdown > a, #mainMenu li> a").on("click", function (e) {
                debugger;
                if ($(window).width() > 979 || $(window).width() < 979) return;
        ...
        v_Map: {
            init: function () {
                ...
                maps.each(function (index, element) {
                    var mapContainer = element,
                        ...
                        fullAddress = mapContainer.getAttribute('data-fulladress'),
                        latitude = mapContainer.getAttribute('data-lat'),
                        longitude = mapContainer.getAttribute('data-lng');

                    Core.v_Map.getCoordinates(mapAddress, mapContainer, mapZoom, mapType, mapColor, mapSaturation, pinLogoURL, fullAddress, latitude, longitude);
            ...
            getCoordinates: function (address, mapContainer, mapZoom, mapType, mapColor, mapSaturation, pinLogoUrl, fullAddress, Latitude, Longitude) {
                ...
                geocoder.geocode({
                    ...
                    if (status === google.maps.GeocoderStatus.OK) {
                        ...
                        jQuery(mapContainer).appear(function () {
                            setTimeout(function () {
                                ...
                                google.maps.event.addListener(companyMarker, 'click', function () {
                                    infowindow.open(mapInstance, companyMarker);
                                });
                        ...
                        var styMap = new google.maps.StyledMapType(sty, { name: "Styled Map" });
                        ...
                        if (mapType === "satellite") {
                            mapTypeIdent = google.maps.MapTypeId.SATELLITE;
                        } else if (mapType === "terrain") {
                            mapTypeIdent = google.maps.MapTypeId.TERRAIN;
                        } else if (mapType === "hybrid") {
                            mapTypeIdent = google.maps.MapTypeId.HYBRID;
                        } else {
                            mapTypeIdent = google.maps.MapTypeId.ROADMAP;
                        }
                        ...
                        var MapSettings = {
                            ...
                            navigationControl: true,
                            navigationControlOptions: { style: google.maps.NavigationControlStyle.SMALL },
                            mapTypeId: mapTypeIdent
                        };
                        var mapObj = new google.maps.Map(mapContainer, MapSettings);
                        var marker = "";
                        ...
                        jQuery(mapContainer).appear(function () {
                            setTimeout(function () {
                                ...
                                google.maps.event.addDomListener(window, 'resize', function () {
                                    mapObj.setCenter(companyPosition);
                                });
                            }, 1000);
                        });

                        if (mapColor !== "") {
                            mapObj.mapTypes.set('map_style', styMap);
                            mapObj.setMapTypeId('map_style');
                        }
                        console.log('Set map with lat lng');
                    }else {
...
!function (e) {
            e(document).ready(function() {
                    ...
                    0 != o.indexOf("win") && 0 != o.indexOf("linux") ||
                        Modernizr.touch ||
                        e.browser.webkit &&
                        (e.webkitSmoothScroll(),
                            console.log("hello webkit"));
                    var t, a = 0;
                    (Modernizr.mq("only all and (min-width: 768px)") && !Modernizr.touch || e("html.ie8").length > 0) &&
                            e(
                                ".main-navigation:not(.onclick) .navbar-nav>li.dropdown, .main-navigation:not(.onclick) li.dropdown>ul>li.dropdown")
                            .hover(function() {
                                    var o = e(this);
                        ...
                        (Modernizr.mq("only all and (max-width: 767px)") ||
                                Modernizr.touch ||
                                e(".main-navigation.onclick").length > 0) &&
                            e(".main-navigation [data-toggle=dropdown], .header-top [data-toggle=dropdown]").on("click",
                                function(o) {
                                    o.preventDefault(),
                                        o.stopPropagation(),
                                        e(this).parent().siblings().removeClass("open"),
                                        e(this).parent().siblings().find("[data-toggle=dropdown]").parent()
                                            .removeClass("open"),
                    ...
                    if (e(".transparent-header").length > 0 &&
                            ...
                            e(window).scroll(function() {
                                ...
                                (i && window.clearTimeout(i),
                                    i = window.setTimeout(function() {
                                            trHeaderHeight = e("header.header").outerHeight(),
                                                e(".transparent-header .tp-bannertimer")
                                                    .css("marginTop", trHeaderHeight + "px")
                                        },
                                        500));
                            })),
                        ...
                        e(".floating-header .slideshow").length > 0
                            ? e(".header-container header.header").addClass("floating-header-on")
                            : e(".header-container header.header").removeClass("floating-header-on"),
                        ...
                        e(window).scroll(function() {
                            e(".header.fixed").length > 0 &&
                                !(e(".transparent-header .slideshow, .floating-header .slideshow").length > 0)
                                ? e(this).scrollTop() > headerTopHeight + headerHeight && e(window).width() > 767
                                ? (e("body").addClass("fixed-header-on"),
                                    e(".header.fixed").addClass("animated fadeInDown"),
                                    e(".header-container").css("paddingBottom", headerHeight + "px"))
                                : (e("body").removeClass("fixed-header-on"),
